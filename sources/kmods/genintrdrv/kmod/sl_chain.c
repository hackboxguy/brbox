/*
 * Copyright (c) 2009  Barco Display Group.
 * All rights reserved.
 *
 * This Software is confidential and proprietary information of Barco Display
 * Group ("Confidential Information"). You shall not disclose such Confidential
 * Information and shall use it only in accordance with the terms of license
 * agreement you entered into with Barco.
 */
