...
#define ADCMN_BOARD_TYPE_TABLE  {"RASPI_A","RASPI_APLUS","RASPI_B","RASPI_BPLUS","RASPI_B2","BAYTRAIL","BAYTRAIL_I210","BBB","RASPI_0","RASPI_3","X86_64","X86_32","Unknown","none","\0"}
