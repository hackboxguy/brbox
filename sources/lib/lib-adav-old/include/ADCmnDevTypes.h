...
#define ADCMN_BOARD_TYPE_TABLE  {"RASPI_A","RASPI_APLUS","RASPI_B","RASPI_BPLUS","RASPI_B2","BAYTRAIL","BAYTRAIL_I210","BBB","RASPI_0","RASPI_0W","RASPI_3","X86_64","X86_32","A5_V11","NEXX_3020","GL_MT300NV2","RASPI_2","RASPI_4","Unknown","none","\0"}
...
//various openwrt system-config types: https://github.com/hackboxguy/openwrt-wrapper/tree/main/configs
#define ADCMN_SYSCFG_TYPE_TABLE  {"raspi-remote-kit","raspi2-remote-kit","hlk-rm04","gl-mt300nv2-remote-kit","gl-mt300nv2-awsiot-demo","Unknown","none","\0"}
