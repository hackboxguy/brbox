...
/*****************************************************************************/
/*const char *rpc_server_result_table[]   = 
	{	STR_RPC_SRV_RESULT_SUCCESS,
		STR_RPC_SRV_RESULT_FAIL,
		STR_RPC_SRV_RESULT_IN_PROGRESS,
		STR_RPC_SRV_RESULT_NOT_STARTED,
		STR_RPC_SRV_RESULT_DEV_TIMEOUT,
		STR_RPC_SRV_RESULT_ARG_ERROR,
		STR_RPC_SRV_RESULT_MEM_ERROR,
		STR_RPC_SRV_RESULT_BUS_ERROR,
		STR_RPC_SRV_RESULT_ACTION_BLOCKED,
		STR_RPC_SRV_RESULT_DEV_NO_ACCESS,
		STR_RPC_SRV_RESULT_UNKNOWN,
		"none",
		"\0"
	};*/
                        ...
                        char* name8,int val8)
{
    ...
    json_object_object_add(pReq->json_resp_obj, name2, json_object_new_int(val2));//param2-int
    json_object_object_add(pReq->json_resp_obj, name3, json_object_new_int(val3));//param3-int
    json_object_object_add(pReq->json_resp_obj, name4, json_object_new_int(val4));//param3-int
    json_object_object_add(pReq->json_resp_obj, name5, json_object_new_int(val5));//param3-int
    json_object_object_add(pReq->json_resp_obj, name6, json_object_new_int(val6));//param3-int
    json_object_object_add(pReq->json_resp_obj, name7, json_object_new_int(val7));//param3-int
    json_object_object_add(pReq->json_resp_obj, name8, json_object_new_int(val8));//param3-int
...
int ADCmnStringProcessor::prepare_result_string(EDISP_PANEL_RESULT result,JsonDataCommObj* pReq)
{
	...
	switch(result)
	{	
		case EDISP_PANEL_RESULT_SUCCESS :pReq->rpc_code=RPC_SRV_RESULT_SUCCESS;break;
		case EDISP_PANEL_RESULT_FAIL    :pReq->rpc_code=RPC_SRV_RESULT_FAIL;break;
		case EDISP_PANEL_RESULT_RESEND    :pReq->rpc_code=RPC_SRV_RESULT_RESEND;break;
		case EDISP_PANEL_RESULT_TIMEOUT :pReq->rpc_code=RPC_SRV_RESULT_TIMEOUT;break;
		default                         :pReq->rpc_code=RPC_SRV_RESULT_UNKNOWN;break;
	}
	convert_server_result_to_string(pReq->rpc_code,result_string);
	pReq->json_resp_obj=json_object_new_object();//remember to delete this object after sending response
	json_object_object_add(pReq->json_resp_obj,RPC_NAME_ARG_RESULT_PARAM, json_object_new_string(result_string));
...
int ADCmnStringProcessor::prepare_result_string(EDISP_PANEL_RESULT result,JsonDataCommObj* pReq,char* result_para_name,char* result_para_value)
{
	char result_string[512];
	switch(result)
	{	
