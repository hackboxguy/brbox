...
using namespace std;
/*****************************************************************************/
typedef enum MODBUSSRV_CMDLINE_OPT_T
{
	MODBUSSRV_CMDLINE_OPT_DEVICE = 100,
	MODBUSSRV_CMDLINE_OPT_UNKNOWN,
	MODBUSSRV_CMDLINE_OPT_NONE
}MODBUSSRV_CMDLINE_OPT;
/*****************************************************************************/
MyCmdline::MyCmdline(CMDLINE_HELPER_MODE cmdline_mode,int portnum,char* version_str):CmdlineHelper(cmdline_mode)
{
	...
	CmdlineHelper.insert_options_entry((char*)"device" ,optional_argument,MODBUSSRV_CMDLINE_OPT_DEVICE);
	CmdlineHelper.insert_help_entry((char*)"--device=/dev/ttyX         (uart device node)");
}
/*****************************************************************************/
MyCmdline::~MyCmdline()
{
...
{
	MODBUSSRV_CMDLINE_OPT command =(MODBUSSRV_CMDLINE_OPT)arg;
	switch(command)
	{
		case MODBUSSRV_CMDLINE_OPT_DEVICE:
