...
#v) IMAGE_VERSION=$OPTARG ;;    #image version
[ "$OUTPUT_DISK" = 0 ] && OUTPUT_DISK=$BR_OUTPUT_FOLDER/images/raspi3-64.img

BINARIES_DIR=$BR_OUTPUT_FOLDER/images
RPI_FMW_DIR=$BINARIES_DIR/rpi-firmware
RPI_KERNEL=$BINARIES_DIR/Image
...
BOOT_MARKER_RPI=$(pwd)/configs/raspi3-64/cmdline.txt #kernel cmdline args file 
BOOT_CONFIG_RPI=$(pwd)/configs/raspi3-64/config.txt
