...
sudo $GRUB1_PREPARE_SCRIPT -o $BR_OUTPUT_FOLDER -i $OUTPUT_DISK_IMAGE -v $IMAGE_VERSION
$GRUB1_COPY_SCRIPT $BR_OUTPUT_FOLDER/host/sbin/grub $OUTPUT_DISK_IMAGE
