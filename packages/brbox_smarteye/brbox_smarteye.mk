...
#
#############################################################
BRBOX_SMARTEYE_STARTNUM=$(call qstrip,$(BR2_PACKAGE_BRBOX_SMARTEYE_INIT_ORDER))
...
BRBOX_SMARTEYE_CONF_OPTS=-DCMAKE_INSTALL_PREFIX="/opt/fmw/" -DAUTO_SVN_VERSION=OFF -DINSTALL_MY_HEADERS=OFF -DSTARTNUM=$(BRBOX_SMARTEYE_STARTNUM)
$(eval $(cmake-package))
