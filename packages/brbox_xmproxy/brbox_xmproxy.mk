...
BRBOX_XMPROXY_CONF_OPTS=-DCMAKE_INSTALL_PREFIX="/opt/fmw/" -DAUTO_SVN_VERSION=OFF -DINSTALL_MY_HEADERS=OFF -DINSTALL_CLIENT=ON -DSTARTNUM=$(BRBOX_XMPROXY_STARTNUM)
$(eval $(cmake-package))
